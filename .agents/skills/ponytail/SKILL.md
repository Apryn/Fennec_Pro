...
- Dangerous laziness is not lazy: never simplify away required validation, security, safety guards, or explicit constraints. If they insist on Y after you proposed the lazy Y-less X, write Y.
